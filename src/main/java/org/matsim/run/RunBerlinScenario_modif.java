...
public final class RunBerlinScenario_modif {

	private static final Logger log = Logger.getLogger(RunBerlinScenario_modif.class );
	...
	public static Config prepareConfig( RunDrtOpenBerlinScenario.AdditionalInformation additionalInformation, String [] args,
		...
		//config.controler().setLastIteration(1);//modifier pour que la dernière itération soit une
